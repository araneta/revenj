...
public class WorldRepository   implements java.io.Closeable, org.revenj.patterns.SearchableRepository<hello.World>, org.revenj.database.postgres.BulkRepository<hello.World>, org.revenj.patterns.PersistableRepository<hello.World> {
	...
	public WorldRepository(
			 ...
			 final hello.converters.WorldConverter converter,
	...
	private final hello.converters.WorldConverter converter;
	...
	public WorldRepository(org.revenj.patterns.ServiceLocator locator) {
		this(locator.tryResolve(java.sql.Connection.class), locator.resolve(javax.sql.DataSource.class), locator.resolve(org.revenj.database.postgres.QueryProvider.class), locator.resolve(hello.converters.WorldConverter.class), locator);
	}
	

	public static org.revenj.patterns.Specification<hello.World> rewriteSpecificationToLambda(org.revenj.patterns.Specification<hello.World> filter) {
	...
	@Override
	public org.revenj.patterns.Query<hello.World> query(org.revenj.patterns.Specification<hello.World> filter) {
		org.revenj.patterns.Query<hello.World> query = queryProvider.query(transactionConnection, locator, hello.World.class);
		if (filter != null) {
	...
	private java.util.List<hello.World> readFromDb(java.sql.PreparedStatement statement, java.util.List<hello.World> result) throws java.sql.SQLException, java.io.IOException {
	...
	@Override
	public java.util.List<hello.World> search(org.revenj.patterns.Specification<hello.World> specification, Integer limit, Integer offset) {
		...
		try (org.revenj.database.postgres.PostgresWriter pgWriter = org.revenj.database.postgres.PostgresWriter.create()) {
			...
			if (specification == null) {
				sql = "SELECT r FROM \"hello\".\"World_entity\" r";
			} 
			else {
				org.revenj.patterns.Query<hello.World> query = query(specification);
				if (offset != null) {
	...
	public java.util.function.BiFunction<java.sql.ResultSet, Integer, java.util.List<hello.World>> search(org.revenj.database.postgres.BulkReaderQuery query, org.revenj.patterns.Specification<hello.World> specification, Integer limit, Integer offset) {
		...
		if (specification == null) {
			sb.append("SELECT array_agg(_r) FROM (SELECT _r FROM \"hello\".\"World_entity\" _r");
		}
		...
		return (rs, ind) -> {
			try {
				...
				rdr.process(res);
				java.util.List<hello.World> result = org.revenj.database.postgres.converters.ArrayTuple.parse(rdr, 0, converter::from); 
	...
	@Override
	public long count(org.revenj.patterns.Specification<hello.World> specification) {
		...
		try (org.revenj.database.postgres.PostgresWriter pgWriter = org.revenj.database.postgres.PostgresWriter.create()) {
			String sql;
			if (specification == null) {
				sql = "SELECT COUNT(*) FROM \"hello\".\"World_entity\" r";
			} 
			else {
				try {
	...
	public java.util.function.BiFunction<java.sql.ResultSet, Integer, Long> count(org.revenj.database.postgres.BulkReaderQuery query, org.revenj.patterns.Specification<hello.World> specification) {
		...
		StringBuilder sb = query.getBuilder();
		if (specification == null) {
			sb.append("SELECT count(*) FROM \"hello\".\"World_entity\" r");
		}
	...
	@Override
	public boolean exists(org.revenj.patterns.Specification<hello.World> specification) {
		...
		try (org.revenj.database.postgres.PostgresWriter pgWriter = org.revenj.database.postgres.PostgresWriter.create()) {
			String sql = null;
			if (specification == null) {
				sql = "SELECT exists(SELECT * FROM \"hello\".\"World_entity\" r";
			} 
			else {
				try {
	...
	public java.util.function.BiFunction<java.sql.ResultSet, Integer, Boolean> exists(org.revenj.database.postgres.BulkReaderQuery query, org.revenj.patterns.Specification<hello.World> specification) {
		...
		StringBuilder sb = query.getBuilder();
		if (specification == null) {
			sb.append("exists(SELECT * FROM \"hello\".\"World_entity\" r");
		}
	...
	@Override
	public java.util.List<hello.World> find(String[] uris) {
	...
	@Override
	public java.util.Optional<hello.World> find(String uri) {
	...
	public java.util.List<hello.World> find(int[] ids, java.sql.Connection connection) {
		try (java.sql.PreparedStatement statement = connection.prepareStatement("SELECT _r FROM \"hello\".\"World_entity\" _r WHERE _r.\"ID\" = ANY(?)");
			org.revenj.database.postgres.PostgresReader reader = org.revenj.database.postgres.PostgresReader.create(locator)) {
			...
			java.util.List<hello.World> result = new java.util.ArrayList<>(ids.length);
			try (java.sql.ResultSet rs = statement.executeQuery()) {
				while (rs.next()) {
					reader.process(rs.getString(1));
					result.add(converter.from(reader));
	...
	public java.util.Optional<hello.World> find(int id, java.sql.Connection connection) {
		try (java.sql.PreparedStatement statement = connection.prepareStatement("SELECT _r FROM \"hello\".\"World_entity\" _r WHERE _r.\"ID\" = ?");
			org.revenj.database.postgres.PostgresReader reader = org.revenj.database.postgres.PostgresReader.create(locator)) {
			...
			java.util.List<hello.World> result = new java.util.ArrayList<>(1);
			result.add(instance);
	...
	@Override
	public java.util.function.BiFunction<java.sql.ResultSet, Integer, java.util.Optional<hello.World>> find(org.revenj.database.postgres.BulkReaderQuery query, String uri) {
		final org.revenj.database.postgres.PostgresReader rdr = query.getReader();
		StringBuilder sb = query.getBuilder();
		int index = query.getArgumentIndex();
		if (uri == null) {
		...
		sb.append("SELECT _r FROM \"hello\".\"World_entity\" _r WHERE _r.\"ID\" = ?");
		...
		return (rs, ind) -> {
			try {
				...
				rdr.process(res);
				hello.World instance = converter.from(rdr);
				if (!hasCustomSecurity) return java.util.Optional.of(instance);
				java.util.List<hello.World> result = new java.util.ArrayList<>(1);
				result.add(instance);
	...
	@Override
	public java.util.function.BiFunction<java.sql.ResultSet, Integer, java.util.List<hello.World>> find(org.revenj.database.postgres.BulkReaderQuery query, String[] uris) {
		final org.revenj.database.postgres.PostgresReader rdr = query.getReader();
		...
		sb.append("SELECT array_agg(_r) FROM \"hello\".\"World_entity\" _r WHERE _r.\"ID\" = ANY(?)");
		final int[] ids = new int[uris.length];
		for (int i = 0; i < uris.length; i++) {
			try {
				ids[i] = Integer.parseInt(uris[i]);
	...
	public static void __setupPersist(
			...
			java.util.function.Consumer<java.util.Collection<hello.World>> delete,
			java.util.function.Function<hello.World, hello.World> track) {
		insertLoop = insert;
		updateLoop = update;
		deleteLoop = delete;
		trackChanges = track;
	...
	private static java.util.function.BiConsumer<java.util.Collection<hello.World>, java.util.Map.Entry<org.revenj.database.postgres.PostgresWriter, org.revenj.patterns.ServiceLocator>> insertLoop;
	private static java.util.function.BiConsumer<java.util.Map.Entry<java.util.List<hello.World>, java.util.List<hello.World>>, java.util.Map.Entry<org.revenj.database.postgres.PostgresWriter, org.revenj.patterns.ServiceLocator>> updateLoop;
	private static java.util.function.Consumer<java.util.Collection<hello.World>> deleteLoop;
	private static java.util.function.Function<hello.World, hello.World> trackChanges;

	private static final String[] EMPTY_URI = new String[0];

	@Override
	public String[] persist(
			java.util.Collection<hello.World> insert,
			java.util.Collection<java.util.Map.Entry<hello.World, hello.World>> update,
			java.util.Collection<hello.World> delete) throws java.io.IOException {
		java.sql.Connection connection = getConnection();
		try (java.sql.PreparedStatement statement = connection.prepareStatement("/*NO LOAD BALANCE*/SELECT \"hello\".\"persist_World\"(?, ?, ?, ?)");
			...
			if (insert != null && !insert.isEmpty()) {
				...
				pgo.setType("\"hello\".\"World_entity\"[]");
				sw.reset();
			...
			if (update != null && !update.isEmpty()) {
				java.util.List<hello.World> oldUpdate = new java.util.ArrayList<>(update.size());
				java.util.List<hello.World> newUpdate = new java.util.ArrayList<>(update.size());
				java.util.Map<String, Integer> missing = new java.util.HashMap<>();
				int cnt = 0;
				for (java.util.Map.Entry<hello.World, hello.World> it : update) {
					hello.World oldValue = trackChanges.apply(it.getValue());
					if (it.getKey() != null) {
						oldValue = it.getKey();
					}
				...
				if (!missing.isEmpty()) {
					java.util.List<hello.World> found = find(missing.keySet().toArray(new String[missing.size()]));
					for (hello.World it : found) {
				...
				pgOld.setType("\"hello\".\"World_entity\"[]");
				pgNew.setType("\"hello\".\"World_entity\"[]");
	...
	@Override
	public String insert(hello.World item) throws java.io.IOException {
		java.sql.Connection connection = getConnection();
		try (java.sql.PreparedStatement statement = connection.prepareStatement("/*NO LOAD BALANCE*/SELECT \"hello\".\"insert_World\"(ARRAY[?])");
			org.revenj.database.postgres.PostgresWriter sw = org.revenj.database.postgres.PostgresWriter.create()) {
			java.util.List<hello.World> insert = java.util.Collections.singletonList(item);
				assignSequenceID.accept(insert, connection);
	...
	@Override
	public void update(hello.World oldItem, hello.World newItem) throws java.io.IOException {
		java.sql.Connection connection = getConnection();
		try (java.sql.PreparedStatement statement = connection.prepareStatement("/*NO LOAD BALANCE*/SELECT \"hello\".\"update_World\"(ARRAY[?], ARRAY[?])");
			 org.revenj.database.postgres.PostgresWriter sw = org.revenj.database.postgres.PostgresWriter.create()) {
			...
			java.util.List<hello.World> oldUpdate = java.util.Collections.singletonList(oldItem);
			java.util.List<hello.World> newUpdate = java.util.Collections.singletonList(newItem);
	...
	public WorldRepository(javax.sql.DataSource dataSource, org.revenj.patterns.ServiceLocator locator) {
		this(java.util.Optional.empty(), dataSource, locator.resolve(org.revenj.database.postgres.QueryProvider.class), locator.resolve(hello.converters.WorldConverter.class), locator);
	}
